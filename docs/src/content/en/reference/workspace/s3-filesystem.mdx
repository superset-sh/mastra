...
name: "forcePathStyle",
type: "boolean",
description: "Force path-style URLs instead of virtual-hosted-style. Required for some S3-compatible services like MinIO. Defaults to true when a custom endpoint is provided.",
isOptional: true,
