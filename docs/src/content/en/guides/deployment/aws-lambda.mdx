...
<Steps>
  ...
  <StepItem>
    ...
    1. Set **Auth type** to **NONE** (for public access)
  ...
  <StepItem>
    ...
    1. Add the required variables for your Mastra application:
  ...
  <StepItem>
    ...
    1. Set the following recommended values:
...
1. Visit the URL in your browser to see your Mastra's server home screen
1. Test your agents and workflows using the generated API endpoints
