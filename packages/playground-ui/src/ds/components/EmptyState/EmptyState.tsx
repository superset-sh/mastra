...
export function EmptyState({
  ...
  return (
    ...
    >
      ...
      <HeadingTag className="font-medium text-neutral5 text-ui-lg">{titleSlot}</HeadingTag>
      {descriptionSlot && <p className="mt-1.5 text-neutral3 text-ui-md max-w-md">{descriptionSlot}</p>}
